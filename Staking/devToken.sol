...
import "./Ownable.sol";
/*
*  DevToken is a development token that we use to learn how to code solidity 
...
contract DevToken is Ownable{
  ...
  */
  ...
  modifier onlyStakeable{
    require(msg.sender== stakeableAddress);
    _;
  }
  ...
  */
  ...
  /*
  *  constructor will be triggered when we create the Smart contract
  ...
  *
  ...
  function burn(address account, uint256 amount) external returns(bool) {
    require(msg.sender == owner() || msg.sender == stakeableAddress);
  ...
  *
  ...
  function setStakeAddress(address stakeableAddress_) external onlyOwner {
    stakeableAddress = stakeableAddress_;
  }
  /*
